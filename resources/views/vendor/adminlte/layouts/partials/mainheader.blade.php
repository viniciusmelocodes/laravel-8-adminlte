            ...
            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            @php
                                            $email = isset($user) ? Gravatar::get($user->email) : '';
                                            @endphp
                                            <img src="{{ $email }}" class="img-circle" alt="User Image" />
                                        </div>
                                    ...
                                    <a href="#">
                                        ...
                                        <div class="progress xs">
                                            ...
                                            <div class="progress-bar progress-bar-aqua" style="width: 20%"
                                                ...
                                                aria-valuemax="100">
                                                <span class="sr-only">20% {{ trans('adminlte_lang::message.complete')
                                                    }}</span>
                                            </div>
                                        </div>
                                    </a>
                ...
                <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px;white-space: nowrap;">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        ...
                        $email = isset($user) ? Gravatar::get($user->email) : '';
                        @endphp
                        <img src="{{ $email }}" class="user-image" alt="User Image" />
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs" data-toggle="tooltip" title="{{ Auth::user()->name }}">{{
                            Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <img src="{{ $email }}" class="img-circle" alt="User Image" />
                            <p>
                                <span data-toggle="tooltip" title="{{ Auth::user()->name }}">{{ Auth::user()->name
                                    }}</span>
